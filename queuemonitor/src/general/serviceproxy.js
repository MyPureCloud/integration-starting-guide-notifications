...
var purecloud_platform_client_v2_1 = require("purecloud-platform-client-v2");
var authorization_1 = require("../middleware/authorization");
/*
  Decorator function that will allow us to apply retry logic on any remote calls
*/
var serviceProxy = function (retryParameters) { return function (target, propertyKey, descriptor) {
    var originalMethod = descriptor.value;
    var targetRetryParams;
    if (!retryParameters) {
    ...
    descriptor.value = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var client, returnValue, err_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        client = purecloud_platform_client_v2_1.ApiClient.instance;
                        client.setAccessToken(authorization_1.getAccessToken());
                    ...
                    case 2:
                        err_1 = _a.sent();
                        console.error("Error while retrieving invoke service: " + propertyKey, err_1);
                        throw err_1;
